    ...
    entries: [
      {
        ...
        tileSize: 'Size_1_x_1',
        displayAssetPath: '/Game/Catalog/DisplayAssets/DA_Featured_Sparks_Bass_BikeMold',
        newDisplayAssetPath: '/OfferCatalog/NewDisplayAssets/S31/DAv2_Sparks_Bass_BikeMold',
        newDisplayAsset: {
          ...
          renderImages: [
            {
              ...
              image: 'https://fortnite-api.com/images/cosmetics/br/newdisplayassets/feba3089b4e22eab/renderimage_0.png',
            },
          ],
        },
        brItems: [
          {
            ...
            name: 'Mark 45 Bass',
            description: "Tony Stark's proprietary bass design from his own collection.",
            type: {
              value: 'backpack',
            ...
            images: {
              smallIcon: 'https://fortnite-api.com/images/cosmetics/br/backpack_bikemold_bass/smallicon.png',
...
describe('useFortniteShop', () => {
  ...
  it('handles non-ok response', async () => {
    ...
    expect(result.current.error?.message).toBe('Failed to fetch Fortnite shop: 500');
  });
}); 